...
.. |Tags|      replace:: :ref:`Source tags <sect-user-tags>`
...
Alternatively, you may also choose to cleanup_ generated objects. In addition,
you are also provided with the ability to generate a source distribution_
tarball.
...
:ref:`clean target <target-clean>` then removes build configuration objects and
...
:ref:`building <sect-user-build>` time. Objects are basically installed under
PREFIX_ directory.
...
Refer to section |Tags| for a list of variables affecting this target
behavior.
