...
root_doc = 'index'
master_title = u'eBuild Documentation'
...
latex_documents = [
    ('index', 'ebuild.tex', master_title, author, 'manual')
]
...
#man_pages = [
#    (root_doc, 'ebuild', master_title, author, 1)
#]
...
texinfo_documents = [
    ('user',
     ...
     author,
     'eBuild',
     'eBuild build system user manual',
     'Software development'),
    ('install',
     'ebuild_install',
     'eBuild Integration Guide',
     author,
     'eBuild Install',
     'eBuild build system integration manual',
     'Software development'),
    ('programmer',
     'ebuild_programmer',
     'eBuild Programmer Guide',
     author,
     'eBuild Recipes',
     'eBuild build system programmer guide',
     'Software development'),
]
